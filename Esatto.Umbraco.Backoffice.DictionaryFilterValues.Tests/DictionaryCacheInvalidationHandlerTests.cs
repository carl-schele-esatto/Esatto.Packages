...
{
    private sealed class CountingCache : IDictionaryFilterValuesCache
    {
        public int InvalidateCount { get; private set; }

        public Task<IReadOnlyList<CachedDictionaryItem>> GetAllAsync()
            => Task.FromResult<IReadOnlyList<CachedDictionaryItem>>(Array.Empty<CachedDictionaryItem>());
