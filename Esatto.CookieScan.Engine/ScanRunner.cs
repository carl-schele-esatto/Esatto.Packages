...
/// </summary>
/// <param name="options">What to scan and how - see <see cref="ScanOptions"/>.</param>
...
/// </param>
/// <param name="log">
/// Where progress goes. The console tool writes lines, the dashboard posts messages to its page;
/// the engine itself knows neither.
/// </param>
