...
public class DashboardAssetsTests
{
    ...
    {
        Assert.False(DashboardAssets.TryOpen("/../Esatto.CookieScan.Desktop.dll", out _, out _));
    }
    ...
    {
        Assert.False(DashboardAssets.TryOpen("/%2E%2E/Esatto.CookieScan.Desktop.dll", out _, out _));
    }
