...
/// <summary>
/// Configuration for the cookie scanner's API user, bound from <c>Esatto:CookieScan:ApiUser</c>.
/// </summary>
/// <remarks>
...
{
    public const string SectionName = "Esatto:CookieScan:ApiUser";
    ...
    public string Email { get; set; } = "cookie-scanner@localhost";
